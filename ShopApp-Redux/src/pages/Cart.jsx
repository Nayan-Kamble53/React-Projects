...
const Cart = () => {
  ...
  useEffect(() => {
//yahape old value mei current value add hori hai and by default initial value 0 hai  
    setTotalAmount(cart.reduce((old, current) => old + current.price, 0));
  }, [cart]);
    ...
    <div className=" h-screen">
      {cart.length > 0 ? (
        <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-center">
          ...
          <div className="w-[100%] md:w-[40%] flex flex-col h-full">
            <div className="flex flex-col p-5 gap-5 my-14  h-[100%] justify-between">
              <div className="flex flex-col gap-5 ">
                ...
                <div className="font-semibold text-4xl text-green-700  -mt-5">
                  Summary
                </div>
            ...
            <div className="total flex flex-col">
              <p className="text-xl font-bold"><span className="text-gray-700 font-semibold">
